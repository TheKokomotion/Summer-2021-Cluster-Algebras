...
#Current filler is using weight cluster W, which I imagine is a list compiled from weight vectors [d, d_1, d_2], yada yada, which I will adapt once we determine how we are storing weight vectors from mutations.
